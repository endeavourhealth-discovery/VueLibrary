...
function hasNodeChildrenByName(data: TTGraphData, name: string): boolean {
...
function toggleNodeByName(data: TTGraphData, name: string): void {
  if (data.name === name) {
...
export { translateFromEntityBundle, toggleNodeByName, hasNodeChildrenByName, addNodes };
