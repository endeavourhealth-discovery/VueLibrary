...
import { DownloadByQueryOptions, ECLQueryRequest, QueryRequest, SearchResponse, SearchResultSummary } from "@/interfaces/AutoGen";
import { TextSearchStyle } from "@/enums/AutoGen";
